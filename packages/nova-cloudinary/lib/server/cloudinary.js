...
Cloudinary.config({
  cloud_name: Telescope.settings.get("dl25y9xfd"),
  api_key: Telescope.settings.get("173649537729756"),
  api_secret: Telescope.settings.get("Y0Xo1zRppyXplqJ_r4m0ZIBO0I0"),
  secure: true,
});
