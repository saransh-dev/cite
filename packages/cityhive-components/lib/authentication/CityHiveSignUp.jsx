...
class CityHiveSignUp extends Component {
    ...
    constructor(props) {
        ...
        this.selectEventChange = this.selectEventChange.bind(this);
        this.state = {
          selVal : '',
          selFirm :'',
          selDepartment :'',
        ...
        this.passEventChange = this.passEventChange.bind(this);
        this.rePassEventChange = this.rePassEventChange.bind(this);
    }

    selectEventChange(val){
      console.log(val);
      if (val.id == 'firm'){
        this.selFirm = val.value;
      } else if (val.id == 'department') {
        this.selDepartment = val.value;
      } else if (val.id == 'jobFunction') {
        this.selJobFunction = val.value;
      } else {
        this.selVal = val.value;
      }
      this.setState({
        value: val.value
      });
      // Assign the selected value on the input ready for submitting

      $('#profession').attr('name', 'profession');
      $('#profession').attr('ref', 'profession');
      $('#profession').attr('value', val.value);

      $('#firm').attr('name', 'firm');
      $('#firm').attr('ref', 'firm');
      $('#firm').attr('value', val.value);

      $('#department').attr('name', 'department');
      $('#department').attr('ref', 'department');
      $('#department').attr('value', val.value);

      $('#jobFunction').attr('name', 'jobFunction');
      $('#jobFunction').attr('ref', 'jobFunction');
      $('#jobFunction').attr('value', val.value);
    ...
    // On Load
    componentDidMount() {
      // $('.password:first-child').attr('ref','password');
      // $('.password:first-child').attr('required','');
    }
    ...
    formSubmit(e) {
      console.log(this);
        ...
        fields.forEach((field) => {
          if (field == 'profession') {
            fieldsObj[field] = this.selVal;
          } else if (field == 'department') {
            fieldsObj[field] = this.selDepartment;
          } else if (field == 'firm') {
            fieldsObj[field] = this.selFirm;
          }  else if (field == 'jobFunction') {
            fieldsObj[field] = this.selJobFunction;
          } else {
                ...
                <form ref="signUp" onSubmit={this.formSubmit}>
                    ...
                    <div className="form-item">
                        <Select
                          ...
                          ref="profession"
                          value={this.selVal}
                          options={this.optionsProfession}
                    ...
                    <div className="form-item">
                        ...
                        <Select
                          inputProps={{
                            'id': 'jobFunction',
                            'value': this.jobFunction
                          }}
                          id="jobFunction"
                          ref="jobFunction"
                          value={this.selJobFunction}
                          options={this.optionsJobFunction}
                          onChange={this.selectEventChange}
                          resetValue={{
                            value: ''
                          }}
                    ...
                    <div className="form-item">
                      <input ref="password" type="hidden" value={this.state.password} required />
                      <PasswordMask
                        value={this.state.password}
                        id="password"
                        name="password"
                        placeholder="Enter password"
                        onChange={this.passEventChange}
                        />
                    </div>

                    <div className="form-item">
                        <input ref="rePassword" type="hidden" value={this.state.rePassword}  required />
                        <PasswordMask
                          value={this.state.rePassword}
                          id="rePassword"
                          name="rePassword"
                          placeholder="Re-type password"
                          onChange={this.rePassEventChange}
                          />
                    </div>
